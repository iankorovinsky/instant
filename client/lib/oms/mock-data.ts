...
export const orders: Order[] = [
  ...
  // Additional DRAFT orders (5)
  {
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-24T12:00:00"),
    lastStateChangeAt: new Date("2024-12-24T12:00:00"),
    notes: "Rebalancing position",
  },
  {
    orderId: "ord-034",
    accountId: "acc-004",
    ...
    timeInForce: "IOC",
    state: "DRAFT",
    createdAt: new Date("2024-12-24T12:15:00"),
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-24T12:15:00"),
    lastStateChangeAt: new Date("2024-12-24T12:15:00"),
  },
  {
    orderId: "ord-035",
    accountId: "acc-006",
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-24T12:30:00"),
    lastStateChangeAt: new Date("2024-12-24T12:30:00"),
  },
  {
    orderId: "ord-036",
    accountId: "acc-008",
    ...
    timeInForce: "DAY",
    state: "DRAFT",
    createdAt: new Date("2024-12-24T13:00:00"),
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-24T13:00:00"),
    lastStateChangeAt: new Date("2024-12-24T13:00:00"),
  },
  {
    orderId: "ord-037",
    accountId: "acc-010",
    ...
    timeInForce: "DAY",
    state: "DRAFT",
    createdAt: new Date("2024-12-24T13:15:00"),
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-24T13:15:00"),
    lastStateChangeAt: new Date("2024-12-24T13:15:00"),
  },

  // Additional APPROVAL_PENDING orders (4)
  {
    orderId: "ord-038",
    accountId: "acc-002",
    instrumentId: "inst-010",
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-24T08:32:00"),
    lastStateChangeAt: new Date("2024-12-24T08:32:00"),
  },
  {
    orderId: "ord-039",
    accountId: "acc-005",
    ...
    state: "APPROVAL_PENDING",
    complianceResult: generateComplianceResult("WARN"),
    createdAt: new Date("2024-12-24T09:45:00"),
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-24T09:47:00"),
    lastStateChangeAt: new Date("2024-12-24T09:47:00"),
  },
  {
    orderId: "ord-040",
    accountId: "acc-003",
    ...
    complianceResult: generateComplianceResult("PASS"),
    batchId: "batch-002",
    createdAt: new Date("2024-12-24T10:15:00"),
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-24T10:17:00"),
    lastStateChangeAt: new Date("2024-12-24T10:17:00"),
  },
  {
    orderId: "ord-041",
    accountId: "acc-006",
  ...
  // Additional APPROVED orders (3)
  {
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-23T12:00:00"),
    lastStateChangeAt: new Date("2024-12-23T12:00:00"),
  },
  {
    orderId: "ord-043",
    accountId: "acc-009",
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-23T14:00:00"),
    lastStateChangeAt: new Date("2024-12-23T14:00:00"),
  },
  {
    orderId: "ord-044",
    accountId: "acc-001",
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-23T15:30:00"),
    lastStateChangeAt: new Date("2024-12-23T15:30:00"),
  },

  // Additional SENT orders (3)
  {
    orderId: "ord-045",
    accountId: "acc-004",
    instrumentId: "inst-008",
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-22T10:00:00"),
    lastStateChangeAt: new Date("2024-12-22T10:00:00"),
    sentToEmsAt: new Date("2024-12-22T10:00:00"),
  },
  {
    orderId: "ord-046",
    accountId: "acc-008",
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-22T12:00:00"),
    lastStateChangeAt: new Date("2024-12-22T12:00:00"),
    sentToEmsAt: new Date("2024-12-22T12:00:00"),
  },
  {
    orderId: "ord-047",
    accountId: "acc-010",
    ...
    lastStateChangeAt: new Date("2024-12-21T14:00:00"),
    sentToEmsAt: new Date("2024-12-21T14:00:00"),
  },

  // Additional PARTIALLY_FILLED orders (2)
  {
    orderId: "ord-048",
    accountId: "acc-002",
    instrumentId: "inst-001",
    ...
    updatedAt: new Date("2024-12-20T15:00:00"),
    lastStateChangeAt: new Date("2024-12-20T15:00:00"),
    sentToEmsAt: new Date("2024-12-20T10:00:00"),
  },
  {
    orderId: "ord-049",
    accountId: "acc-005",
    ...
    lastStateChangeAt: new Date("2024-12-19T16:00:00"),
    sentToEmsAt: new Date("2024-12-19T11:00:00"),
  },

  // Additional FILLED orders (4)
  {
    orderId: "ord-050",
    accountId: "acc-006",
    instrumentId: "inst-002",
    ...
    lastStateChangeAt: new Date("2024-12-18T14:00:00"),
    sentToEmsAt: new Date("2024-12-18T10:00:00"),
    fullyFilledAt: new Date("2024-12-18T14:00:00"),
  },
  {
    orderId: "ord-051",
    accountId: "acc-007",
    ...
    createdAt: new Date("2024-12-17T10:00:00"),
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-17T15:00:00"),
    lastStateChangeAt: new Date("2024-12-17T15:00:00"),
    sentToEmsAt: new Date("2024-12-17T11:00:00"),
    fullyFilledAt: new Date("2024-12-17T15:00:00"),
  },
  {
    orderId: "ord-052",
    accountId: "acc-009",
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-16T16:00:00"),
    lastStateChangeAt: new Date("2024-12-16T16:00:00"),
    sentToEmsAt: new Date("2024-12-16T12:00:00"),
    fullyFilledAt: new Date("2024-12-16T16:00:00"),
  },
  {
    orderId: "ord-053",
    accountId: "acc-001",
    ...
    lastStateChangeAt: new Date("2024-12-15T10:30:00"),
    sentToEmsAt: new Date("2024-12-15T09:30:00"),
    fullyFilledAt: new Date("2024-12-15T10:30:00"),
  },

  // Additional CANCELLED orders (2)
  {
    orderId: "ord-054",
    accountId: "acc-003",
    instrumentId: "inst-007",
  ...
  },
  {
    ...
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-19T17:00:00"),
    lastStateChangeAt: new Date("2024-12-19T17:00:00"),
  },

  // Additional REJECTED orders (1)
  {
    orderId: "ord-056",
    accountId: "acc-010",
    instrumentId: "inst-009",
    ...
    state: "REJECTED",
    complianceResult: generateComplianceResult("BLOCK"),
    createdAt: new Date("2024-12-18T13:00:00"),
    createdBy: "advisor@instant.com",
    updatedAt: new Date("2024-12-18T13:15:00"),
    lastStateChangeAt: new Date("2024-12-18T13:15:00"),
  },
];
...
export const orderFills: OrderFill[] = [
  ...
  // Fills for ord-048 (PARTIALLY_FILLED - 85k of 140k)
  { fillId: "fill-015", orderId: "ord-048", quantity: 50000, price: 99.10, timestamp: new Date("2024-12-20T12:00:00") },
  { fillId: "fill-016", orderId: "ord-048", quantity: 35000, price: 99.12, timestamp: new Date("2024-12-20T15:00:00") },

  // Fills for ord-049 (PARTIALLY_FILLED - 60k of 95k)
  { fillId: "fill-017", orderId: "ord-049", quantity: 40000, price: 97.05, timestamp: new Date("2024-12-19T13:00:00") },
  { fillId: "fill-018", orderId: "ord-049", quantity: 20000, price: 97.02, timestamp: new Date("2024-12-19T16:00:00") },

  // Fills for ord-050 (FILLED - 115k)
  { fillId: "fill-019", orderId: "ord-050", quantity: 70000, price: 97.55, timestamp: new Date("2024-12-18T12:00:00") },
  { fillId: "fill-020", orderId: "ord-050", quantity: 45000, price: 97.58, timestamp: new Date("2024-12-18T14:00:00") },

  // Fills for ord-051 (FILLED - 64k)
  { fillId: "fill-021", orderId: "ord-051", quantity: 64000, price: 97.20, timestamp: new Date("2024-12-17T15:00:00") },

  // Fills for ord-052 (FILLED - 135k)
  { fillId: "fill-022", orderId: "ord-052", quantity: 80000, price: 96.65, timestamp: new Date("2024-12-16T14:00:00") },
  { fillId: "fill-023", orderId: "ord-052", quantity: 55000, price: 96.68, timestamp: new Date("2024-12-16T16:00:00") },

  // Fills for ord-053 (FILLED - 58k)
  { fillId: "fill-024", orderId: "ord-053", quantity: 58000, price: 98.85, timestamp: new Date("2024-12-15T10:30:00") },
];
